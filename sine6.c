...
void setup() {
  ...
  for (int n = 0; n < 500; n++)
  {
    ...
    //samples[n] = (short) (127.0/2 * (fabs(sin(2 * 3.14 * t))+fabs(sin(8 * 3.14 * t))) + 127.0 ); //calculating the sin value at each time instance
    //samples[n] = (short) (127.0/2 * (fabs(sin(2 * 3.14 * t))+fabs(sin(4 * 3.14 * t))) + 127.0 ); //calculating the sin value at each time instance
    samples[n] = (short) (127.0/2 * (fabs(cos(1 * 3.14 * t))+fabs(sin(2 * 3.14 * t))+fabs(tan(3 * 3.14 * t))) + 127.0 ); //calculating the sin value at each time instance
    //samples[n] = (short) (127.0/2 * (fabs(cos(2 * 3.14 * t))+fabs(sin(4 * 3.14 * t))) + 127.0 ); //calculating the sin value at each time instance
